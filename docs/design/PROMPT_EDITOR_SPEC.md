...
| `remove_silences` | `threshold_db`(−30), `min_dur`(0.5), `keep_pad`(0.1) | (2) `remove_silences(track="v1", …)` | `duration_shrank(min_ratio=0.02)` iff facts predict silence, `silence_total_leq(max_total_s=1.0, needs_render)` |
...
| `silence_total_leq` | verify render + `silencedetect` |
